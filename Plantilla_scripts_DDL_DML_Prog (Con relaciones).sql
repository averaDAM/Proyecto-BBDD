...
INSERT INTO Temporadas VALUES (1, 'Primera Temporada');*/

ALTER TABLE personajes ADD CONSTRAINT FK_Raza FOREIGN KEY (raza) REFERENCES razas(nombre);
/*ALTER TABLE personajes ADD CONSTRAINT FK_Especialista FOREIGN KEY (especialista) REFERENCES armas(tipo);*/

ALTER TABLE armas ADD CONSTRAINT FK_Fabricante FOREIGN KEY (fabricante) REFERENCES razas(nombre);

ALTER TABLE personajes ADD CONSTRAINT FK_Titulo FOREIGN KEY (titulo) REFERENCES titulos(nombre);

ALTER TABLE anillos ADD CONSTRAINT FK_Portadoras FOREIGN KEY (personas_portadoras) REFERENCES personajes(sobrenombre);

/*ALTER TABLE capitulos ADD CONSTRAINT FK_Personajes_Aparecen FOREIGN KEY (nombre) REFERENCES personajes(sobrenombre);
ALTER TABLE capitulos ADD CONSTRAINT FK_Personas_Mueren FOREIGN KEY (nombre) REFERENCES personajes(sobrenombre);

ALTER TABLE temporadas ADD CONSTRAINT FK_Capitulos FOREIGN KEY (capitulos) REFERENCES capitulos(nombre);*/
